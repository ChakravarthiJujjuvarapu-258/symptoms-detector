...
const Route = createFileRoute("/history")({
  head: () => ({
    meta: [
      { title: "Assessment History \u2014 AI Symptoms Detector" },
      {
        name: "description",
        content: "Review, search, export or delete your previous symptom assessments. All records are stored locally in your browser."
      },
  ...
  >
                <CardContent className="space-y-3 py-5">
                  ...
                  <ul className="flex flex-wrap gap-1.5">
                    {r.conditions.slice(0, 3).map((c) => <li
    key={c.name}
