...
const SYMPTOMS: SymptomDef[] = [
  {
    ...
    label: "Fever",
    category: "Systemic",
    aliases: ["fever", "temperature", "chills", "feverish"],
    weight: 2,
  },
  {
    key: "cough",
  ...
  },
  {
    ...
    label: "Sore throat",
    category: "Respiratory",
    aliases: ["sore throat", "throat pain", "swallow"],
    weight: 1,
  },
  {
    key: "runny_nose",
    label: "Runny nose",
    category: "Respiratory",
    aliases: ["runny nose", "congestion", "stuffy", "sneezing", "blocked nose"],
    weight: 1,
  },
  {
    key: "breathless",
    ...
    category: "Respiratory",
    aliases: ["difficulty breathing", "shortness of breath", "breathless", "wheez"],
    weight: 4,
  },
  {
    key: "headache",
  ...
  },
  {
    ...
    label: "Dizziness",
    category: "Neurological",
    aliases: ["dizzy", "dizziness", "lightheaded", "vertigo", "fainting"],
    weight: 2,
  },
  {
    key: "fatigue",
    label: "Fatigue",
    category: "Systemic",
    aliases: ["fatigue", "tired", "exhaust", "weak", "weakness"],
    weight: 1,
  },
  {
    key: "body_ache",
    ...
    aliases: ["body ache", "muscle", "joint pain", "aching", "back pain"],
    weight: 1,
  },
  {
    key: "nausea",
    ...
    category: "Digestive",
    aliases: ["nausea", "vomit", "sick to my stomach", "throwing up"],
    weight: 2,
  },
  {
    key: "diarrhea",
    label: "Diarrhea",
    category: "Digestive",
    aliases: ["diarrhea", "diarrhoea", "loose stool", "stomach upset"],
    weight: 2,
  },
  {
    key: "abdominal",
    ...
    category: "Digestive",
    aliases: ["abdominal", "stomach pain", "belly pain", "cramps"],
    weight: 2,
  },
  {
    key: "chest_pain",
    label: "Chest pain",
    category: "Cardiac",
    aliases: ["chest pain", "chest tightness", "chest pressure"],
    weight: 5,
  },
  {
    key: "palpitations",
    label: "Palpitations",
    category: "Cardiac",
    aliases: ["palpitation", "racing heart", "heart pounding", "irregular heartbeat"],
    weight: 3,
  },
  {
    key: "rash",
    label: "Rash",
    category: "Skin",
    aliases: ["rash", "hives", "itchy skin", "spots"],
    weight: 1,
  },
  {
    key: "urinary",
    ...
    category: "Urinary",
    aliases: ["urin", "burning when", "peeing", "bladder"],
    weight: 2,
  },
  {
    key: "thirst",
    ...
    category: "Metabolic",
    aliases: ["thirst", "frequent urination", "dry mouth"],
    weight: 2,
  },
  {
    key: "taste_loss",
    ...
    category: "Systemic",
    aliases: ["loss of taste", "loss of smell", "can't taste", "cant smell"],
    weight: 3,
  },
  {
    key: "swelling",
    label: "Swelling",
    category: "Systemic",
    aliases: ["swelling", "swollen", "edema"],
    weight: 2,
  },
  {
    key: "anxiety",
    ...
    aliases: ["anxiety", "anxious", "panic", "stress", "depress"],
    weight: 1,
  },
];
...
const CONDITIONS: ConditionDef[] = [
  {
    ...
    explanation:
      "A mild viral infection of the nose and throat that usually resolves on its own within 7–10 days.",
    commonSymptoms: ["Runny or blocked nose", "Sneezing", "Sore throat", "Mild cough"],
    treatment:
      "Rest, fluids, saline rinses and over-the-counter symptom relief. Antibiotics do not help viral colds.",
  ...
  },
  {
    ...
    explanation:
      "A viral illness that typically starts abruptly with fever, muscle aches and marked fatigue.",
    commonSymptoms: ["Sudden fever", "Muscle aches", "Dry cough", "Severe tiredness"],
    treatment:
      "Rest, fluids and fever control. Antiviral medicine may help if started early, especially for higher-risk people.",
  ...
  },
  {
    ...
    explanation:
      "A respiratory viral infection with a wide range of severity; loss of taste or smell is a suggestive feature.",
    commonSymptoms: ["Fever", "Cough", "Loss of taste or smell", "Fatigue"],
    treatment:
      "Isolation where appropriate, rest, fluids and monitoring of oxygen levels. Seek care if breathing worsens.",
  ...
  },
  {
    ...
    boost: ["fever", "fatigue"],
    explanation:
      "Inflammation or infection of the airways that causes a persistent cough, sometimes with breathlessness.",
    commonSymptoms: ["Persistent cough", "Chest congestion", "Wheezing", "Low-grade fever"],
    treatment:
      "Supportive care and inhalers where prescribed. Medical review is advised if breathing becomes difficult.",
  ...
  },
  {
    ...
    boost: ["cough"],
    explanation:
      "Airway narrowing triggered by allergens, infection or irritants, causing wheeze and breathlessness.",
    commonSymptoms: ["Wheezing", "Chest tightness", "Night-time cough", "Breathlessness"],
    treatment:
      "Use of prescribed reliever inhalers and avoidance of triggers. Urgent care if the reliever is not helping.",
  ...
  },
  {
    ...
    explanation:
      "Irritation of the stomach and intestines, usually viral or food-related, causing vomiting and diarrhea.",
    commonSymptoms: ["Nausea", "Vomiting", "Diarrhea", "Cramping abdominal pain"],
    treatment:
      "Oral rehydration, small bland meals and rest. Seek care for signs of dehydration or blood in stool.",
  ...
  },
  {
    ...
    explanation:
      "A bacterial infection of the bladder or urinary tract causing burning and frequent urination.",
    commonSymptoms: [
  ...
  },
  {
    ...
    explanation:
      "A common primary headache disorder, often with light sensitivity, nausea or a tight band-like pain.",
    commonSymptoms: ["Throbbing or pressing head pain", "Light sensitivity", "Nausea"],
    treatment:
      "Rest in a quiet dark room, hydration and simple analgesia. Persistent patterns deserve medical review.",
  ...
  },
  {
    ...
    explanation:
      "Excessive thirst, frequent urination and tiredness can reflect poorly controlled blood glucose.",
    commonSymptoms: ["Thirst", "Frequent urination", "Fatigue", "Blurred vision"],
    treatment:
      "Blood glucose testing and review of diet, medication and monitoring with a clinician.",
  ...
  },
  {
    ...
    explanation:
      "Chest discomfort with breathlessness or palpitations can have a cardiac cause and must be evaluated urgently.",
  ...
  },
  {
    ...
    explanation:
      "Stress and anxiety can produce very real physical symptoms once medical causes have been excluded.",
    commonSymptoms: ["Racing heart", "Restlessness", "Shallow breathing", "Poor sleep"],
    treatment:
      "Breathing techniques, sleep and caffeine review, and talking therapies where symptoms persist.",
  ...
  },
  {
    ...
    explanation:
      "An immune reaction to an allergen causing skin changes, itching and sometimes swelling.",
    commonSymptoms: ["Itchy rash or hives", "Swelling", "Sneezing", "Watery eyes"],
    treatment:
      "Avoid the suspected trigger; antihistamines may help. Any facial or throat swelling is an emergency.",
...
export function analyzeSymptoms(input: AssessmentInput): AnalysisResult {
  ...
  if (conditions.length === 0) {
    conditions.push({
      ...
      treatment:
        "Monitor how symptoms evolve and discuss them with a clinician if they persist or worsen.",
    });
  }
  ...
  if (risk === "emergency") {
    recommendations.push(
      "Call your local emergency services or go to the nearest emergency department now",
    );
  ...
  if (risk === "moderate")
    recommendations.push("Book a doctor appointment within the next 24–48 hours");
  if (risk === "low")
    recommendations.push("Book a doctor appointment if symptoms persist beyond a week");
  if (chronic > 0)
    recommendations.push(
      "Tell your clinician about your existing medical conditions and medications",
    );
  recommendations.push(
    "Call emergency services immediately if symptoms become severe or you struggle to breathe",
  );

  const categoryMap = new Map<string, number>();
  matched.forEach((s) =>
    categoryMap.set(s.category, (categoryMap.get(s.category) ?? 0) + s.weight),
  );
...
> = {
  ...
  emergency: {
    label: "Emergency",
    description:
      "Potentially life-threatening features detected. Seek immediate medical attention.",
